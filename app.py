...
def app():
	 st.title("Sentiment  Analyzer  🔥🔥🔥🔥")
  	...
  	if choice=="Sentiment Tweet Analyzer":
		...
		st.write("2. Performing Sentiment Analysis a displays the result in form of a Bar Graph")
        raw_text = st.text_area("Enter the twitter handle of the Personality (without @)")
        ...
        if st.button("Analyze"):
            ...
            print(Drumil T Joshi('https://www.linkedin.com/in/drumil-joshi-00636716a/'))

	st.subheader(' ------------------------Credits to DRUMIL T JOSHI ----------------------')
